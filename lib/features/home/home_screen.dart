...
class HomeScreen extends StatelessWidget {
    ...
    return SliverAppBar(
      ...
      actions: [
        Padding(
          ...
          child: IconButton(
            icon: const Icon(Icons.notifications_none_rounded, color: Colors.indigo, size: 28),
            onPressed: () {},
          ),
        ),
      ],
  ...
  Widget _buildQuickActionGrid(String lang, BuildContext context) {
    return GridView.count(
      ...
      children: [
        _actionCard(Icons.school_rounded, "Result Portal", Colors.orange, () => _launchURL("https://nubtkhulna.ac.bd/ter/")),
        _actionCard(Icons.facebook_rounded, "Notice Feed", Colors.blue, () => _launchURL("https://www.facebook.com/groups/2141673572851512")),
        _actionCard(Icons.language_rounded, "Website", Colors.green, () => _launchURL("https://nubtkhulna.ac.bd/")),
        _actionCard(Icons.event_available_rounded, "Social Media", Colors.purple, () => _launchURL("https://www.facebook.com/nubtkofficial")),
      ],
    );
  }
  ...
  Widget _noticeSection() {
    return SizedBox(
      ...
      child: ListView(
        ...
        physics: const BouncingScrollPhysics(),
        children: const [
          _NoticeCard(title: 'Admission', subtitle: 'Spring 2026', icon: Icons.campaign_rounded, color: Colors.blue),
          _NoticeCard(title: 'Exams', subtitle: 'Mid-term Start', icon: Icons.event_note_rounded, color: Colors.red),
          _NoticeCard(title: 'Holiday', subtitle: 'Eid-ul-Fitr', icon: Icons.celebration_rounded, color: Colors.orange),
        ],
      ),
    );
  }
