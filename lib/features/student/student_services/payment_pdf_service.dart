// D:\projects\nubtk_pilot\lib\features\student\student_services\payment_pdf_service.dart
          ...
          return pw.Padding(
            ...
            child: pw.Column(
              ...
              children: [
                pw.Header(
                  level: 0,
                  child: pw.Text("NUBTK - OFFICIAL MONEY RECEIPT",
                    style: pw.TextStyle(color: PdfColors.indigo900, fontWeight: pw.FontWeight.bold, fontSize: 18)),
                ),
                ...
                pw.Container(
                  ...
                  decoration: const pw.BoxDecoration(color: PdfColors.green100, borderRadius: pw.BorderRadius.all(pw.Radius.circular(5))),
                  child: pw.Text("STATUS: PAID SUCCESSFULLY",
